            ...
            for attempt in range(max_attempts):
                ...
                if len(fiber_pixels) >= 10:
                    ...
                    for x, y in fiber_pixels:
                        # Optimization: Use explicit bounds check to avoid SWIG exception overhead
        ...
        try:
            ...
            for x in range(max(0, int(cell.xCOM) - search_radius), 
                ...
                for y in range(max(0, int(cell.yCOM) - search_radius), 
                    ...
                    # Optimization: Loop boundaries are explicitly constrained by self.dim to avoid SWIG exception overhead
